...
// Import manifest (generated by generate-manifest.js)
// Fallback to empty if manifest doesn't exist yet
let manifest = { '7days': [], 'this-month': [] }
try {
  manifest = (await import('./assets/manifest.json')).default
} catch {
...
function getImages(folder) {
  ...
  if (files.length > 0) {
    // Use manifest order (sorted by real file creation time)
    return files
      .map(filename => {
  ...
  // Fallback: just return all images unsorted if manifest is empty
...
const sevenDaysImages = getImages('7days')
const monthImages = getImages('this-month')
